(()=>{
'use strict';
const CORE_V='5.3.5',STABILITY_V='5.3.6-rc1',TRACE_V='5.4.0-rc1';
...
async function boot(){
 addStyle('./cloud-core.css','cybertrmx-cloud-style');addStyle('./security-v52.css','cybertrmx-security-style');addStyle('./guard-v528.css','cybertrmx-guard-style');addStyle('./jobs-r2.css','cybertrmx-jobs-v53-style');
 if(STABILITY_536)addStyle('./stability-v536.css','cybertrmx-stability-v536-style',STABILITY_V);
 if(TRACE_540)addStyle('./trace-lab-v540.css','cybertrmx-trace-v540-style',TRACE_V);
 try{await load('./guard-v528.js','cybertrmx-guard-v528')}catch(error){console.error('CYBERTRMX Production Guard failed',error)}
 try{
  await load('./backend-config.js','cybertrmx-backend-config',TRACE_540?TRACE_V:CORE_V);
  ...
  if(STABILITY_536)await load('./stability-transport-v536.js','cybertrmx-stability-transport-v536',STABILITY_V);
  ...
  if(STABILITY_536)await load('./patch-hotfix-v536.js','cybertrmx-patch-hotfix-v536',STABILITY_V);
  ...
  if(TRACE_540){await load('./trace-lab-v540.js','cybertrmx-trace-v540',TRACE_V);await load('./patch-hotfix-v540.js','cybertrmx-patch-hotfix-v540',TRACE_V)}
