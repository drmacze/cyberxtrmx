...
async function boot(){
 ...
 addStyle('./jobs-r2.css','cybertrmx-jobs-r3-style');
 ...
 try{
  ...
  await load('./security-r3.js','cybertrmx-security-r3');
  await load('./jobs-r3.js','cybertrmx-jobs-r3');
  await load('./cloud-core.js','cybertrmx-cloud-core');
 }catch(error){console.error('CYBERTRMX staging bootstrap failed',error)}
}
boot();
})();
