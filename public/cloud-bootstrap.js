...
async function boot(){
 ...
 try{
  ...
  await load('./auth-redirect-fix.js','cybertrmx-auth-redirect-fix');await load('./security-utils.js','cybertrmx-security-utils');await load('./device-transport-v535.js','cybertrmx-device-transport-v535');await load('./security-r3.js','cybertrmx-security-v53');
